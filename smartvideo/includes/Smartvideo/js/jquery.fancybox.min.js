...
(!(function (t, e, n, o) {
	...
	if (((t.console = t.console || { info(t) {} }), n)) {
		if (n.fn.fancybox) {
		...
		(n.extend(b.prototype, {
			...
			addEvents() {
				...
				(e.removeEvents(),
					...
					r.on('keydown.fb', function (t) {
						const o = n.fancybox ? n.fancybox.getInstance() : null,
							i = o.current,
							a = t.keyCode || t.which;
						if (9 == a) {
			...
			loadSlide(t) {
				...
				if (!t.isLoading && !t.isLoaded) {
					if (
						((t.isLoading = !0), !1 === a.trigger('beforeLoad', t))
					) {
			...
			resolveImageSlideSize(t, e, n) {
				const o = parseInt(t.opts.width, 10),
	...
	(function (t, e, n) {
		...
		const o = (function () {
			...
			r = function (t) {
				...
				for (let e = 0, o = t[0].attributes, i = o.length; e < i; e++) {
			...
			c = function (e) {
				const n = t.getComputedStyle(e)['overflow-y'],
	...
	(function (t, e) {
		...
		(e.extend(n.prototype, {
			...
			e(t).on({
				...
				'beforeClose.fb onDeactivate.fb'(t, e) {
					const n = e && e.SlideShow;
					n && n.stop();
				},
			}),
			e(t).on('visibilitychange', function () {
				const n = e.fancybox.getInstance(),
					o = n && n.SlideShow;
	...
	(function (t, e, n) {
		'use strict';
		function o() {
			const e = t.location.hash.substr(1),
				n = e.split('-'),
				o =
